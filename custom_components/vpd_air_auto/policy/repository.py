...
class PolicyRepository:
    ...
    def _parse_global_policy(self, raw_global: Mapping[str, Any]) -> GlobalPolicy:
        ...
        return GlobalPolicy(
            ...
            display=DisplayPolicy(
                icon=self._str_or_default(
                    raw_global.get(CONF_ICON), display_defaults.icon
                ),
                ...
                dew_point_icon=self._str_or_default(
                    raw_global.get(CONF_DEW_POINT_ICON),
                    display_defaults.dew_point_icon,
                ),
    ...
    @classmethod
    def _entity_id_or_none(cls, value: Any) -> str | None:
        candidate = cls._optional_str(value)
