"""Subscription management for source state listeners."""
...
class SubscriptionManager:
    """Track and refresh source state-change subscriptions."""
    ...
    def tracked_entity_ids(self) -> set[str]:
        """Return tracked source entity ids."""
    ...
    def refresh(
        ...
        *,
        ...
        """Refresh listener for the currently active device contexts."""
        tracked_entity_ids = {
            entity_id
    ...
    async def shutdown(self) -> None:
        """Remove active state listener and clear tracked ids."""
        if self._unsub_state_listener is not None:
            self._unsub_state_listener()
            self._unsub_state_listener = None
