"""Topology discovery for source devices and source entities."""
...
class TopologyDiscoveryService:  # pylint: disable=too-few-public-methods
    """Discover device topology for VPD source sensors."""
    ...
    def discover(self) -> dict[str, DeviceTopology]:
        """Build source topology for all devices with temp+humidity pairs."""
