...
def test_enabled_kinds_returns_only_enabled_sensor_kinds() -> None:
    """Enabled kinds should mirror integration option flags."""
...
def test_creatable_kinds_for_topology_removes_blocked_kinds() -> None:
    """Creatable kinds should subtract blocked kinds from enabled kinds."""
...
def test_creatable_kinds_for_topology_none_returns_empty_set() -> None:
    """Missing topology should produce no creatable kinds."""
    service = EntityPlanService(_options())
