...
def test_discover_returns_topology_with_best_sources_and_blocked_kinds(
    ...
    """Discover topology for devices with matching temperature and humidity sources."""
    ...
    assert duplicate_detection.calls == [["sensor.grow_tent_temperature", "sensor.grow_tent_humidity"]]
